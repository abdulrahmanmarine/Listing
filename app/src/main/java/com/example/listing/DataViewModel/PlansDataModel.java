...
import com.example.listing.AssignDialog_Configured.AssignPair;
...
public class PlansDataModel extends ViewModel {
    ...
    LoadAction load = new LoadAction("99001", "2021", "1", "5",
        ...
        Vehicle vehicle3 = new Vehicle("2","Medium", "Crane", "456234", "1000",
                "Red", "2012", "DDMMYYYY", "123456", drivers2);
        Vehicle vehicle4 = new Vehicle("2","Medium", "Crane", "456234", "1000",
                "Red", "2012", "DDMMYYYY", "123456", drivers2);
        ...
        temp.add(new Plan("LOAD", false, "", "RELE",
